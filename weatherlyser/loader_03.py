...
DEFAULT_CHMI_DATA_PATH = pathlib.Path(__file__).parent / "data" / "P1PRUZ01.xlsx"

# Exercise 03.01:
# a. Create a Pandera model for the output data frame and add check_types decorator
# b. Create a test for a valid input file
# c. Create a test for an invalid input file showing the SchemaError
